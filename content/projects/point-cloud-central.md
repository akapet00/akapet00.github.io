...
- **[Optimal neighborhood selection](https://medium.com/@akapet00/beyond-one-size-fits-all-enhancing-accuracy-of-point-cloud-features-with-adaptive-neighborhood-f5fd7ff8cca4)** — Finding the right scale for local analysis by minimizing eigenentropy
- **[Surface point extraction](https://medium.com/@akapet00/a-simple-technique-for-extracting-points-on-the-surface-of-3-d-models-7dc75a7ac75f)** — Isolating surface points from volumetric data using normal-based detection
